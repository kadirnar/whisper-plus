...
class ASRDiarizationPipeline:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        """
        Transcribe the audio sequence(s) given as inputs to text and label with speaker information.

        audio is first passed to the speaker diarization pipeline, which returns timestamps for 'who spoke The input
