...
def find_alignment(
    ...
    *,
    ...
    return [
        WordTiming(word, tokens, start, end, probability) for word, tokens, start, end, probability in zip(
...
def add_word_timestamps(
    ...
    **kwargs,
    ...
    text_tokens_per_segment = [[token for token in segment["tokens"] if token < tokenizer.eot]
