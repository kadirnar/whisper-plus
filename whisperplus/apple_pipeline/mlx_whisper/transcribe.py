    ...
    **decode_options,
    ...
    if verbose:
        ...
        if system_encoding != "utf-8":
            make_safe = lambda x: x.encode(system_encoding, errors="replace").decode(system_encoding)
        else:
    ...
    def new_segment(*, start: float, end: float, tokens: mx.array, result: DecodingResult):
                        ...
                        for si in range(len(current_segments)):
                            ...
                            if is_segment_anomaly(segment):
                                ...
                                silence_before = (
                                    ...
                                    segment["start"] < threshold or segment["start"] - time_offset < 2.0)
                                silence_after = (
